...
function getExplanation(word) {
  ...
  const wordExplanations = {
    ...
    "эксперт": "Ударение на второй слог - экспЕрт. Неправильно: Экслерт.",
    ...
    "вероисповедание": "Ударение на пятый слог - вероисповЕдание. Неправильно: вероисповедАние.",
    ...
    "кремень": "Ударение на второй слог - кремЕнь. Неправильно: крЕмень.",
    "кровоточить": "Ударение на третий слог - кровоточИть. Неправильно: кровотОчить.",
    "кулинария": "Ударение на третий слог - кулинАрия. Неправильно: кулинАрия.",
    "ловкач": "Ударение на второй слог - ловкАч. Неправильно: лОвкач.",
    "маневры": "Ударение на второй слог - манЁвры. Буква Ё всегда ударная.",
    "мельком": "Ударение на первый слог - мЕльком. Неправильно: мелькОм.",
    "мозаичный": "Ударение на третий слог - мозаИчный. Неправильно: мозАичный.",
    "молох": "Ударение на второй слог - молОх. Неправильно: мОлох.",
    "намерение": "Ударение на третий слог - намерЕние. Неправильно: намЕрение.",
    "недуг": "Ударение на второй слог - недУг. Неправильно: нЕдуг.",
    "некролог": "Ударение на третий слог - некролОг. Неправильно: некрОлог.",
    "ненависть": "Ударение на первый слог - нЕнависть. Неправильно: ненавИсть.",
    "нефтепровод": "Ударение на предпоследний слог - нефтепроВод. Неправильно: нефтепрОвод.",
    "новорожденный": "Ударение на третий слог - новорождЁнный. Буква Ё всегда ударная.",
    "норма": "Ударение на первый слог - нОрма. Неправильно: нормА.",
    ...
    "понимание": "Ударение на третий слог - понимАние. Неправильно: понятИе.",
    ...
    "сантиметр": "Ударение на второй слог - сантИметр. Неправильно: сантимЕтр.",
    "свекла": "Правильно: свЁкла (буква Ё всегда ударная). Неправильно: свеклА.",
    "сироты": "Ударение на второй слог - сирОты (мн.ч.). Единственное число - сИрота.",
    "сосредоточение": "Ударение на пятый слог - сосредоточЕние. Неправильно: сосредотОчение.",
    ...
    "тотчас": "Ударение на второй слог - тотчАс. Неправильно: тОтчас.",
    ...
    "углубленный": "Ударение на второй слог - углУбленный. Неправильно: углублЁнный.",
    ...
    "шасси": "Ударение на второй слог - шасИ. Несклоняемое существительное.",
    "шофер": "Ударение на первый слог - шОфер. Современная норма: водитель.",
    ...
    "языковой": "Ударение на третий слог - языковОй (относящийся к языку). ЯзЫковой (относящийся к языку как органу).",
